...
const ExperienceCard = () => {
  return (
    <div className="flex flex-col sm:flex-row bg-gray-400 border-l-4 border-yellow-500 shadow-md rounded-lg p-3 sm:p-4 max-w-full sm:max-w-3xl mx-auto my-4">
      ...
      <div className="text-gray-800 text-sm sm:text-base">
        ...
        <p className="text-sm text-yellow-800 mb-2 font-bold">2021 – Present</p>
        <ul className="list-disc list-inside space-y-1 sm:text-sm md:text-lg font-semibold">
          <li>
