...
function GetInTouch() {
  ...
  return (
    <div className=" text-black py-16 px-8 mr-5 ml-5 bg-gray-100 min-h-screen">
      <div className="text-center mb-12">
        <h2 className="text-3xl text-black-400 font-bold">Let's Connects</h2>
        <p className="text-xl mt-4">
          Got an idea? Let’s connect and explore how we can turn it into
          something amazing.
        </p>
      </div>

      <div className="flex flex-col lg:flex-row justify-between items-start space-y-8 lg:space-y-0">
        <div className="w-full lg:w-1/4 bg-gradient-to-r from-blue-100  to-blue-300 p-8 rounded-lg shadow-lg text-center lg:text-left">
          <h3 className="text-2xl  mb-4 text-blue-900 font-bold">
            Get In Touch
          </h3>
          <p className="mb-2">
            <strong>Email:</strong>
          ...
          <div className="mt-6 font-semibold p-4 align-middle">
            ...
            <div className="flex justify-center px-14 m-2 lg:justify-start space-x-4">
              ...
              >
                <img src={linkedin} alt="linkedin" className="w-12 h-12 mr-2" />
              </a>
              <a
                ...
                rel="noopener noreferrer"
              >
                <img src={github} alt="github" className="w-12 h-12 mr-2" />
              </a>
              <a
                ...
                rel="noopener noreferrer"
              >
                <img src={email} alt="email" className="w-12 h-12 mr-2" />
              </a>
            </div>
          </div>
        </div>
        ...
        <form
          ...
          className="w-auto lg:max-w-2/4 bg-gradient-to-r from-blue-100  to-blue-300  p-8 rounded-lg shadow-lg"
        >
          <input
            type="text"
            name="name"
